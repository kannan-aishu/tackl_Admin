...
export default function Dashboard (){
    ...
    return(
        ...
        <div className='p-[30px] mt-[50px] flex flex-col gap-[30px] w-full '>
           ...
           <div className='bg-white p-[30px] w-full flex flex-col gap-[30px]'>
            <div className='flex w-full justify-between'>
            <p>User's graph</p>
            <select className='border-[#b3afaf] text-[#b3afaf] flex felx-col items-center border-[1px] rounded-md'>
                <option >Outober</option>
            </select>
            </div>
            <img src={Graph} alt="" className='h-[60vh] w-[80%]' />
           </div>
