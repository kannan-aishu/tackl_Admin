...
export default function Navbar (){
  ...
  <img src={Ban} alt="Profile" className='h-10 w-10 rounded-full object-cover' />
  <div className='flex flex-col'>
    <p className='font-semibold w-max truncate'>Moni Roy</p>
    <p className='text-gray-500 text-sm'>Admin</p>
  </div>
  <IoIosArrowDown className='text-[40px]  border border-gray-300 rounded-full w-[40px] h-[20px]'/>
</div>
